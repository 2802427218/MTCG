...
parser.add_argument("--file_loc", type=str, default="../results/predict_final.txt")
parser.add_argument(
    "--specify",
    type=str,
    default=None
...
model_list = ['eval_model/Yelp2-checkpoint-64000', 'eval_model/AGnews-checkpoint-6000', 'eval_model/Toxic-checkpoint-3000']
